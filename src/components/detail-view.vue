          ...
          <div class="movie_top">
            <div class="col-md-9 movie_box">
              ...
              <div class="desc1 span_3_of_2">
                <p class="movie_option"><strong>Genre: </strong>{{ data.genre }}</p>
                <p class="movie_option"><strong>Date of premier: </strong>{{ data.premuere }}</p>
                <p class="movie_option"><strong>Tagline: </strong>{{ data.slogan }}</p>
                <p class="movie_option"><strong>Director: </strong><a href="#">{{ data.director }} </a></p>
                <p class="movie_option"><strong>Age restriction: </strong>{{ data.ageRest }}</p>
                <div class="down_btn"><a class="btn1" :href="data.url" target="_blank"><span> </span>Watch</a></div>
              </div>
              <div class="clearfix"></div>
              ...
              <div class="single">
                ...
                <ul class="single_list">
                  <li>
                    <div class="preview"><a href="#"><img src="@/assets/images/2.jpg" class="img-responsive" alt=""></a>
                    </div>
                    <div class="data">
                  ...
                  <li>
                    <div class="preview"><a href="#"><img src="@/assets/images/3.jpg" class="img-responsive" alt=""></a>
                    </div>
                    <div class="data">
                      ...
                      <p>Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel
                        ...
                        facer possim assum. Typi non habent </p>
                    </div>
                    <div class="clearfix"></div>
                  </li>
                  <li>
                    <div class="preview"><a href="#"><img src="@/assets/images/4.jpg" class="img-responsive" alt=""></a>
                    </div>
                    <div class="data">
                      ...
                      <p>Claritas est etiam processus dynamicus, qui sequitur mutationem consuetudium lectorum. Mirum
                        ...
                        parum clari, fiant sollemnes in futurum. qui sequitur mutationem consuetudium lectorum. Mirum
                        est notare quam littera gothica, quam nunc putamus parum claram,</p>
                    </div>
                    <div class="clearfix"></div>
                  </li>
                  <li class="middle">
                    <div class="preview"><a href="#"><img src="@/assets/images/5.jpg" class="img-responsive" alt=""></a>
                    </div>
                  ...
                  <li class="last-comment">
                    <div class="preview"><a href="#"><img src="@/assets/images/6.jpg" class="img-responsive" alt=""></a>
                    </div>
                    <div class="data-last">
                      <div class="title">mr.dev / 2 hours ago / <a href="#">reply</a></div>
                      <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod
                  ...
                  <li>
                    <div class="preview"><a href="#"><img src="@/assets/images/7.jpg" class="img-responsive" alt=""></a>
                    </div>
                    <div class="data">
